          ...
          <section className="my-2">
            ...
            <div className="container bg-dark-subtle shadow py-2 border-1 border-black">
              ...
              <div>
                ...
                <p>
                  "<b>Tortas & Co</b>" es el blog ideal para todos los amantes
                  de la repostería. Aquí aprenderás técnicas, secretos, recetas
                  y consejos para convertirte en un verdadero maestro pastelero
              ...
              <div>
                <ul>
                  <li>
                    ...
                    facilitarán cada preparación. Descubre cómo lograr bizcochos
                    esponjosos, coberturas perfectas y decoraciones encantadoras
                    sin complicarte.
                  </li>
                  <li>
                    <strong>COCCIÓN Y TÉCNICAS:</strong> Aprende sobre tiempos
                    de horneado, técnicas de batido, temperaturas ideales y
                    métodos para lograr resultados profesionales en tus postres.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    clásicos que nos transportan a la infancia: tortas, budines,
                    galletitas, facturas y delicias con sabor a hogar.
                  </li>
                  <li>
                    <strong>APRENDIENDO A REPOSTEAR:</strong> Paso a paso guiado
                    por reposteros expertos para que puedas crear tus postres
                    favoritos desde cero, incluso si recién comienzas.
                  </li>
                  <li>
              ...
              <div>
                <p>
                  Explora cada categoría para descubrir recetas irresistibles,
                  ideas creativas y contenido que hará brillar tus postres. ¡Tu
                  aventura repostera comienza aquí!
                </p>
              </div>
            </div>
          </section>
